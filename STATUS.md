...
Gerado por `gerar-status.py` no commit `bfb9765`, de 23/08/2026 17:58.
...
| --- | --- | --- |
| ChatGPT (glossário) | 23/08/2026 17:23 | as 42 entradas × 8 línguas, às cegas |
| Whisper (áudio) | 23/08/2026 17:23 | os 8 áudios contra os sync/*.json |
