...
Gerado por `gerar-status.py` no commit `9ac05c1`, de 26/08/2026 00:04.
...
| --- | --- | --- |
| ChatGPT (glossário) | 25/08/2026 23:46 | as 42 entradas × 8 línguas, às cegas |
| Whisper (áudio) | 25/08/2026 23:45 | os 8 áudios contra os sync/*.json |
