...
Gerado por `gerar-status.py` no commit `63aee7f`, de 24/08/2026 15:06.
...
| --- | --- | --- |
| ChatGPT (glossário) | 24/08/2026 14:12 | as 42 entradas × 8 línguas, às cegas |
| Whisper (áudio) | 24/08/2026 14:12 | os 8 áudios contra os sync/*.json |
