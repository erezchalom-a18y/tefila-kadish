...
Gerado por `gerar-status.py` no commit `c54adc2`, de 03/09/2026 17:20.
...
| --- | --- | --- |
| ChatGPT (glossário) | 03/09/2026 00:39 | as 42 entradas × 8 línguas, às cegas |
| Whisper (áudio) | 03/09/2026 00:38 | os 8 áudios contra os sync/*.json |
...
| sefaradi_yatom | 86/91 (94.5%) | -0.14s | -0.99s | 3 | 2 | 2 |
| sefaradi_derabanan | 115/125 (92.0%) | -0.14s | -0.84s | 7 | 0 | 3 |
| **total** | | | | **15** | **12** | **191** |
