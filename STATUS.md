...
Gerado por `gerar-status.py` no commit `ed14dfb`, de 25/08/2026 17:59.
...
| --- | --- | --- |
| ChatGPT (glossário) | 25/08/2026 03:14 | as 42 entradas × 8 línguas, às cegas |
| Whisper (áudio) | 25/08/2026 03:14 | os 8 áudios contra os sync/*.json |
