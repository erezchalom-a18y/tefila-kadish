...
Gerado por `gerar-status.py` no commit `79d1c00`, de 25/08/2026 23:44.
...
| --- | --- | --- |
| ChatGPT (glossário) | 25/08/2026 18:02 | as 42 entradas × 8 línguas, às cegas |
| Whisper (áudio) | 25/08/2026 18:00 | os 8 áudios contra os sync/*.json |
