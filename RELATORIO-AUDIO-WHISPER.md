...
Gerado em 2026-08-25 02:01 UTC por `whisper-1`, sobre o commit `fd7ed21`.
...
- `בְּחַיֵּיכוֹן` *(bechayechon)* — no texto em 14.98s, o Whisper não ouviu
...
- `אָמֵן` *(amên)* — nós: 130.46s · ouvido: 129.82000732421875s · diferença -0.64s
