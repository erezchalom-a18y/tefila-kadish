...
Gerado em 2026-08-24 00:18 UTC por `whisper-1`, sobre o commit `c6741ec`.
...
Dos 420 apontamentos do Whisper, **116** caem em versos que já
...
- `בְּעָלְמָא` *(bealma)* — nós: 3.36s · ouvido: 4.5s · diferença +1.14s
