...
Gerado em 2026-08-25 03:14 UTC por `whisper-1`, sobre o commit `0ba0f1a`.
...
Dos 179 apontamentos do Whisper, **46** caem em versos que já
...
- `וְנֶחֱמָתָא` *(venechemata)* — no texto em 59.34s, o Whisper não ouviu
